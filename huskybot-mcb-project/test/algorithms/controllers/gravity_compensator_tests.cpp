...
{
    GravityCompensator compensator(
        {.cgX = 0.0f, .cgZ = 0.0f, .gravityCompensationScalar = 5000.0f});
...
TEST(GravityCompensatorTest, cg_directly_forward_peaks_at_level_pitch)
{
    ...
    GravityCompensator compensator(
        {.cgX = 30.0f, .cgZ = 0.0f, .gravityCompensationScalar = 5000.0f});
...
TEST(GravityCompensatorTest, cg_offset_angle_shifts_where_effort_peaks)
{
    ...
    GravityCompensator compensator(
        {.cgX = 1.0f, .cgZ = 1.0f, .gravityCompensationScalar = 5000.0f});
